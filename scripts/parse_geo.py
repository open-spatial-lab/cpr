...
sections['geometry'] = sections['polygon'].centroid
# %%
...
# %%
# key_join_info = sections[['CO_MTRS', 'GEOID', "ZIP", "ELSD", "SCSD", "UNSD", "COUNTY","TOWNSHIP"]]
...
# drop ELSD SCSD UNSD
sections = sections.drop(columns=['ELSD', 'SCSD', 'UNSD'])
# %%
