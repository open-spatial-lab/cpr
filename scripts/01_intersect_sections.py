...
if __name__ == "__main__":
  ...
  # townships.to_file('../data/geo/ca-townships-meridian-IDs.geojson', driver='GeoJSON')
...
#%%
ca_zctas = gpd.read_parquet('../data/census_geos/ca-zip.parquet')
# %%
ca_zctas = ca_zctas.to_crs("EPSG:4326")
ca_zctas.to_file('../data/geo/ca-zip.geojson', driver='GeoJSON')
# %%
