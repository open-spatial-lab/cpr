...
chem_chars = pd.read_parquet(path.join(data_dir, "meta", "chemicals.parquet"))[[
  'chem_code',
  'ai_class',
  'ai_type',
  'ai_type_specific'
...
calpip_data = calpip_data.merge(chem_chars, left_on="chem_code", right_on="chem_code", how="left")
...
county_config = {
    ...
    "agg_cols": [
      ...
      'ai_class','ai_type','ai_type_specific'
    ],
...
ca_to_census_configs = [
  {
    ...
    "agg_cols": [
      'aerial_ground', 'usetype', 
      'chem_code', 'county_cd', 'prodchem_pct',
      'prodno', 'site_code',  'monthyear', 'MeridianTownshipRange',
      'ai_class','ai_type','ai_type_specific'
    ],
...
},
  {
    ...
    "agg_cols": [
      'aerial_ground', 'usetype', 
      'chem_code', 'county_cd', 'prodchem_pct',
      'prodno', 'site_code',  'monthyear', 'comtrs', 'MeridianTownshipRange',
      'ai_class','ai_type','ai_type_specific'
    ],
    "agg_id_col": "comtrs",
    "drop_cols": [],
